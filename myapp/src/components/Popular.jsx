...
const PopularMoviePage = () => {
  ...
  return (
    <section className="max-w-350 mt-20 mx-auto">
      <h2 className="mb-3 lg:mb-5 text-lg font-semibold lg:ml-13 bg-amber-300 text-black justify-center w-65 flex items-center">
        Popular Movies <MdLocalMovies className="ml-1" />
      </h2>
      {renderViews()}
